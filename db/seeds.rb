...
Fee.create(start_date: Date.today , end_date: Date.today + 1.year , amount: 160, fee_type: 0, subject_id: @maths.id)
Fee.create(start_date: Date.today , end_date: Date.today + 1.year , amount: 160, fee_type: 0, subject_id: @english.id)
